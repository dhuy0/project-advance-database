                ...
                IF EXISTS (SELECT * FROM THONGTINTHANHTOAN T JOIN CHITIETHOSOBENHNHAN CTHS ON CTHS.MABENHNHAN = T.MABENHNHAN JOIN INSERTED I ON I.MATHANHTOAN = T.MATHANHTOAN)
                        BEGIN
                            ...
                            DECLARE @TONGDIEUTRI INT = (SELECT SUM(T1.TONGTIENTHANHTOAN)
                                            FROM THONGTINTHANHTOAN T1 JOIN CHITIETHOSOBENHNHAN CTHS1 ON CTHS1.MABENHNHAN = T1.MABENHNHAN JOIN INSERTED I ON I.MABENHNHAN = CTHS1.MABENHNHAN
                            ...
                            DECLARE @TONGTHANHTOAN INT = (SELECT SUM(T2.TIENDATRA)
                                            FROM THONGTINTHANHTOAN T2 JOIN CHITIETHOSOBENHNHAN CTHS2 ON CTHS2.MABENHNHAN = T2.MABENHNHAN JOIN INSERTED I ON I.MABENHNHAN = CTHS2.MABENHNHAN
...
-- VALUES ('000007', '000105', '01/01/2020', '02/02/2022', 1, 500, 1, N'TIỀN MẶT', '001733')

-- SELECT * FROM THONGTINTHANHTOAN

-- -- SELECT * FROM THONGTINTHANHTOAN
-- INSERT INTO HOADONDIEUTRI(MAHOADON, MADIEUTRI, MOTA, NGAYDIEUTRI, PHIDIEUTRI)
-- VALUES ('000007', '000143', 'DEO CO MO TA', '21/12/2022', 10)
